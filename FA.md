...
ProxyCloud اکنون در [AUR](https://aur.archlinux.org/packages/proxycloud-gui-bin) موجود است، بنابراین می‌توانید آن را با استفاده از ابزار کمکی AUR مورد نظر خود نصب کنید.
...
- **DNS از راه دور**: سرورهای DNS سفارشی را برای اتصالات رمزگذاری شده از راه دور تنظیم کنید
- **DNS مستقیم**: سرورهای DNS را برای اتصالات مستقیم پیکربندی کنید
...
- **Mux (چندگانه‌سازی)**: مدیریت اتصال را بهینه کنید
